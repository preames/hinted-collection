...
// was 16
// controlled for benchmarking via GC_MARKERS
# endif
...
#   if 0//preames/hack!
    ...
    GC_parallel = FALSE;
#else //HINTGC hackery
    // This isn't strictly needed for HINTGC, but it is needed for the
    // microbenchmark setup we use.  You may want to decide for yourself
