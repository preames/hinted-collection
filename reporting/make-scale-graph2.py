...
def cond10(x):
    if x[1] < 100000000:
        return x[0] < 13 and x[0] > 8
    else:
        return x[0] < 10.5 and x[0] > 9.5
def cond25(x):
    if x[1] < 100000000:
        return x[0] < 35 and x[0] > 15
    else:
        return x[0] < 26 and x[0] > 24

def cond50(x):
    if x[1] < 100000000:
        return x[0] < 62 and x[0] > 40
    else:
        return x[0] < 51 and x[0] > 49

def cond75(x):
    if x[1] < 100000000:
        return x[0] < 80 and x[0] > 70
    else:
        return x[0] < 78 and x[0] > 72


def cond90(x):
    if x[1] < 100000000:
        return x[0] < 95 and x[0] > 85
    else:
        return x[0] < 93 and x[0] > 87


import copy
orig_together = copy.deepcopy(together)
...
plot2d_data("generated/scale-size-"+basename+"-10perc", x, y1, y2, "Heap Size (MB)", "Time (msec)")
...
plot2d_data("generated/scale-size-"+basename+"-25perc", x, y1, y2, "Heap Size (MB)", "Time (msec)")
...
plot2d_data("generated/scale-size-"+basename+"-50perc", x, y1, y2, "Heap Size (MB)", "Time (msec)")

#print orig_together
together = filter( cond75, orig_together)
together = sorted(together, key=lambda x: x[1]) # by size
...
plot2d_data("generated/scale-size-"+basename+"-75perc", x, y1, y2, "Heap Size (MB)", "Time (msec)")


together = filter( cond90, orig_together)
together = sorted(together, key=lambda x: x[1]) # by size
...
plot2d_data("generated/scale-size-"+basename+"-90perc", x, y1, y2, "Heap Size (MB)", "Time (msec)")
